...
function SignIn() {
  ...
  // const has_token = localStorage.getItem('qikstarter-token') ? true : false
  ...
  function submitForm(e) {
    ...
    //       localStorage.setItem('qikstarter-token', response.headers['x-token'])
      ...
      <div className="sign-in-container">
        ...
        <div className="sign-in-content">
          ...
          <form className="sign-in-form" onSubmit={submitForm} status={status}>
            <div className="sign-in-title text-orange">Qikstarter</div>
